...
database = System.get_env("DB_ASSESSMENT_NAME_DEV") || "assessment_api_dev"
...
config :assessment_api, AssessmentApi.Web.Repo,
  adapter: Ecto.Adapters.Postgres,
  url: url,
  ssl: ssl,
  pool_size: 10

config :assessment_api, AssessmentApi.Web.WriteRepo,
  adapter: Ecto.Adapters.Postgres,
  url: url,
  ssl: ssl,
  pool_size: 10
